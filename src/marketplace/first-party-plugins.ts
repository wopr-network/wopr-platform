// src/marketplace/first-party-plugins.ts
// Authoritative first-party plugin manifest data.
// The DB (marketplace_plugins.manifest column) is the runtime source of truth.
// This file provides:
//   1. The seed data for scripts/seed-marketplace-plugins.ts (populates DB on first run)
//   2. A compile-time fallback for the setup route until it is migrated to DB lookups
...
export const FIRST_PARTY_PLUGINS: PluginManifest[] = [
    ...
    setup: [
      {
        ...
        fields: [
          { key: "maxEntries", label: "Max Memory Entries", type: "number", required: false, placeholder: "10000" },
          {
            key: "embeddingModel",
            label: "Embedding Model",
            type: "select",
      ...
      { id: "done", title: "Memory Ready", description: "Semantic memory is configured and ready.", fields: [] },
    ],
    installCount: 9800,
    changelog: [
  ...
  },
  {
    ...
    setup: [
      ...
      { id: "done", title: "Voice Ready", description: "TTS is configured and ready.", fields: [] },
    ],
    installCount: 5600,
    changelog: [
  ...
  },
  {
    ...
    setup: [
      ...
      { id: "done", title: "STT Ready", description: "Speech-to-text is configured and ready.", fields: [] },
    ],
    installCount: 3200,
    changelog: [
  ...
  },
  {
    ...
    setup: [
      ...
      { id: "done", title: "Webhooks Ready", description: "Webhook endpoints are configured.", fields: [] },
    ],
    installCount: 7100,
  ...
  },
  {
    ...
    setup: [
      ...
      { id: "done", title: "GitHub Connected", description: "GitHub integration is configured.", fields: [] },
    ],
    installCount: 4500,
    changelog: [
    ...
    setup: [
      {
        ...
        fields: [
          ...
          { key: "autoJoin", label: "Auto-join Voice Channels", type: "boolean", required: false },
        ],
      },
      { id: "done", title: "Transcriber Ready", description: "Meeting transcriber is configured.", fields: [] },
    ],
    installCount: 2100,
  ...
  },
  {
    ...
    setup: [
      ...
      { id: "done", title: "Art Bot Ready", description: "AI Art Bot is configured.", fields: [] },
    ],
    installCount: 3800,
    changelog: [
  ...
  },
  {
    ...
    setup: [
      ...
      { id: "done", title: "Web UI Ready", description: "Web chat interface is configured.", fields: [] },
    ],
    installCount: 6300,
  ...
  },
  {
    ...
    setup: [
      ...
      { id: "done", title: "Moderation Ready", description: "Content moderation is configured.", fields: [] },
    ],
    installCount: 4200,
    ...
    setup: [
      {
        ...
        fields: [
          { key: "retentionDays", label: "Data Retention (days)", type: "number", required: false, placeholder: "90" },
        ],
      },
      { id: "done", title: "Analytics Ready", description: "Analytics dashboard is configured.", fields: [] },
    ],
    installCount: 2800,
