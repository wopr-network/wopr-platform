...
function createMockNodeConnections(overrides: Partial<NodeConnectionManager> = {}): NodeConnectionManager {
  return {
    findBestTarget: vi.fn().mockReturnValue(null),
    sendCommand: vi.fn().mockResolvedValue({ id: "cmd-1", type: "command_result", command: "test", success: true }),
