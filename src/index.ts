...
if (process.env.NODE_ENV !== "test") {
  ...
  // Wire billing tRPC router deps
  {
    ...
    const { SpendingLimitsRepository } = await import("./monetization/spending-limits-repository.js");
    ...
    const spendingLimitsRepo = new SpendingLimitsRepository(billingDrizzle2);
