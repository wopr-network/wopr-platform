...
function setupStore(): { store: AccountDeletionStore; sqlite: Database.Database } {
  ...
  sqlite.exec(`
    ...
    CREATE TABLE bot_instances (id TEXT PRIMARY KEY, tenant_id TEXT NOT NULL, name TEXT NOT NULL, billing_state TEXT NOT NULL DEFAULT 'active', suspended_at TEXT, destroy_after TEXT, created_at TEXT NOT NULL DEFAULT (datetime('now')), updated_at TEXT NOT NULL DEFAULT (datetime('now')));
    ...
    CREATE TABLE tenant_customers (tenant TEXT PRIMARY KEY, stripe_customer_id TEXT NOT NULL, tier TEXT NOT NULL DEFAULT 'free', billing_hold INTEGER NOT NULL DEFAULT 0, created_at INTEGER NOT NULL DEFAULT (unixepoch()), updated_at INTEGER NOT NULL DEFAULT (unixepoch()));
